...
choice_main_menu_erorr = f'Нужно ввести число от 1 до {len(main_menu)-1}!'
...
edit_contact = [f'Ведите новое имя ({no_changes}):',
                f'Ведите новый телефон ({no_changes}):',
                f'Ведите новой комментарий ({no_changes}):',]
...
input_search_word_for_delete = 'Введите слово для поиска которое хоитте удалить: '


def new_contact_added_successful(name: str) -> str:
    return f'Контакт "{name}" успешно добавлен!'

def delete_contact_added_successful(name: str) -> str:
